...
const SECTIONS: Section[] = [
  ...
  {
    title: "Nova Poshta",
    keys: ["np_demo_mode", "np_api_key", "np_sender_ref", "np_sender_contact_ref", "np_sender_city_ref", "np_sender_warehouse_ref", "np_sender_warehouse_ref_oversized", "np_sender_phone", "np_weight_uah_per_kg"],
